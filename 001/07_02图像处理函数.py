...
# filename:ts07.02.py # TensorFlow图像处理函数
...
#读取图片E:\pythoncharmlearning\datasets\cat.jpg(把源代码中的b换成了rb调试成功)
image_raw_data = tf.gfile.FastGFile("../../datasets/yanxin.jpg", 'rb').read()
